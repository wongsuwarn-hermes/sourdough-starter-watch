...
export function phaseLabel(phase) {
  ...
  if (normalized === 'rising') return 'R+';
  if (normalized === 'falling') return 'F−';
  if (normalized === 'peak' || normalized === 'peaking') return 'PK';
  if (normalized === 'fed' || normalized === 'baseline') return '0';
  return '—';
}
