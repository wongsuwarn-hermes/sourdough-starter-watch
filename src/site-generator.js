...
function logoSvg() {
  return `<svg viewBox="0 0 48 48" role="img"><path d="M17 13h14l2 5v19a6 6 0 0 1-6 6h-6a6 6 0 0 1-6-6V18l2-5Z" fill="#fff7df" stroke="#23251d" stroke-width="2"/><path d="M18 13h12l-1-6H19l-1 6Z" fill="#f54e00" stroke="#23251d" stroke-width="2"/><path d="M18 28c4-4 8 4 13 0v8a4 4 0 0 1-4 4h-6a4 4 0 0 1-4-4v-7c.3-.3.6-.6 1-.9Z" fill="#f7a501" opacity=".85"/><circle cx="24" cy="27" r="3.2" fill="#23251d"/><path d="M10 25c3.6-5.2 8.3-7.8 14-7.8s10.4 2.6 14 7.8c-3.6 5.2-8.3 7.8-14 7.8S13.6 30.2 10 25Z" fill="none" stroke="#23251d" stroke-width="2" stroke-linecap="round"/></svg>`;
}
